...
Viewport.prototype.animate = function() {
  ...
  if(Math.abs(this.torqueX) > 1.0 || Math.abs(this.torqueY) > 1.0) {
    ...
    if(this.calculatedSide !== this.currentSide) {
      ...
      if (this.calculatedSide == 1) {
        styleMessage = "eins";
      }
      else if (this.calculatedSide == 2) {
        styleMessage = "zwei";
      }
      else if (this.calculatedSide == 3) {
        styleMessage = "drei";
      }
      else if (this.calculatedSide == 4) {
        styleMessage = "vier";
      }
      else if (this.calculatedSide == 5) {
        styleMessage = "fünf";
      }
      else if (this.calculatedSide == 6) {
        styleMessage = "sechs";
      }
      ctx.clearRect(0, 0, c.width, c.height);
      ctx.fillText(this.calculatedSide + ": " + styleMessage, 10, 100);
    }
