...
function getTimeMini() {
  ...
  document.getElementById('clock-hour-pointer-mini').style.transform = "rotate("+360/12*timeDecimal+"deg)";                      //Der Stundenzeiger wird an die korrekte Stelle rotiert
  document.getElementById('clock-minute-pointer-mini').style.transform = "rotate("+360/60*time.substring(3, 5)+"deg)";       //Der Minutenzeiger wird an die korrekte Stelle rotiert
}
